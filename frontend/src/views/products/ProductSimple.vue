<template>
    <div>
        ...
        <div class="main-panel">
            ...
            <div class="center" v-if="this.ready">
                    ...
                    <div class="row col-12">
                        <div class="col-12 mb-5 content-full-width">
                            <ul role="tablist" class="nav nav-tabs nav-fill">
                                ...
                                <li class="nav-item">
                                    <a v-on:click="tab='categorieseattributes'" class="nav-link nav-link-success" :class="{ 'active' : tab=='categorieseattributes'}" id="categorieseattributes-tab" href="#" role="tab" ><b>Categorie e attributi</b></a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="tab-pane fade show" :class="{ 'active' : tab=='categorieseattributes'}"  role="tabpanel" aria-labelledby="categoriesedescriptions-tab">
                            <div class="col-12 pb-0 mb-0">
                                <h6>Categoria</h6>
                                <ul>
                                <li v-for="value,key in categories[this.marketplace.id]" :key="key" :id="value.id">
                                    
                                        <input type="radio" class="mr-2" :name="this.marketplace.id+'name'" :checked="this.product.categories.includes(value.id)">
                                        <strong style="text-transform:uppercase;">{{value.title}}</strong>
                                        <ul>
                                            <li v-for="value,key in value.childs" :key="key" :id="value.id">
                                            <input type="radio" class="mr-2" :name="this.marketplace.id+'name'" :checked="this.product.categories.includes(value.id)">
                                            <strong style="text-transform:uppercase;">{{value.title}}</strong>
                                        </li>
                                    </ul>
        ...
        async getProduct(){
                ...
                this.axios.get("/api/products/simple/"+this.$route.query.id+"/?company="+this.company.id).then((res)=>{
                        ...
                        for(var i=0;i<res.data.categories.length;i++){
                            this.product.categories.push(res.data.categories[i].id);
                        }
